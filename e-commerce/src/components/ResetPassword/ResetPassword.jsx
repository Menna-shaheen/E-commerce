    ...
    <div className="md:w-1/2 mx-auto my-8 py-7">
      ...
      <form className="mx-auto" onSubmit={formik.handleSubmit}>
        ...
        {formik.errors.resetCode && formik.touched.resetCode && (
          <div
            className="p-4 mb-4 text-sm text-red-800 "
            role="alert"
          >
        ...
        {loading ? (
          <button
            type="button"
            className="text-white bg-green-800 hover:bg-green-700 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center duration-300  "
          >
